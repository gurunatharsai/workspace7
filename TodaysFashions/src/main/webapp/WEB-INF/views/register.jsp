...
<div class="form-group">
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
    ...
    <div class="form-group">
     <br><label class="col-md-4 control-label"><b>Email</b></label>
     <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  ...
  <div class="col-md-4"><br>
    ...
    <a href="login"><button type="submit" class="btn btn-success" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSUBMIT <span class="glyphicon glyphicon-send"></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button></a>
  </div>
</div>
